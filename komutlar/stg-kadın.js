...
const tag = 'ケ'   
const kadınrol = message.guild.roles.cache.find(r => r.id === '807865941395767367') 
...
** <:OnaylanmPng:796462123341447168> Kişiye ${kadınrol} Rolü verilip adı \`${tag} ${name} | ${age}\` olarak güncellendi.** 
